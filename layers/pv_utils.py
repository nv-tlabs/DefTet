...
from layers.pv_module import SharedMLP, PVConv, PointNetSAModule, PointNetAModule, PointNetFPModule
...
def create_pointnet_components(blocks, in_channels, with_se=False, normalize=True, eps=0,
                               width_multiplier=1, voxel_resolution_multiplier=1, scale_pvcnn=False):
    ...
    for out_channels, num_blocks, voxel_resolution in blocks:
        ...
        if voxel_resolution is None:
            ...
            block = functools.partial(PVConv, kernel_size=3, resolution=int(vr * voxel_resolution),
                                      with_se=with_se, normalize=normalize, eps=eps, scale_pvcnn=scale_pvcnn)
