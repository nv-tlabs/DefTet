...
void dr_forward_batch(at::Tensor gt_point_clouds_bxpx3, at::Tensor face_bxfx3x3, at::Tensor closest_f, at::Tensor closest_d) {
	...
	dr_cuda_forward_batch(gt_point_clouds_bxpx3, face_bxfx3x3, closest_f, closest_d);
	return;
}
