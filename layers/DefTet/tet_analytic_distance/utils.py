...
tet_analytic_distance = load(name="tet_analytic_distance",
...
class VarianceFunc(Function):
    ...
    @staticmethod
    def forward(ctx, gt_point_clouds_bxpx3, face_bxfx3x3):
        ...
        tet_analytic_distance.forward(gt_point_clouds_bxpx3, face_bxfx3x3, closest_f, closest_d)
    ...
    def backward(ctx, dl_dclosest_d, dl_dcloest_f):
        ...
        tet_analytic_distance.backward(gt_point_clouds_bxpx3, face_bxfx3x3, closest_f, dl_dclosest_d, dldtet_bxfx3x3)
        # import ipdb
        # ipdb.set_trace()
        # print('Finished')
        ...
        return None, dldtet_bxfx3x3

###############################################################
tet_analytic_distance_f = VarianceFunc.apply
